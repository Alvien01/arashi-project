...
export default defineNuxtConfig({
  ...
  seo: {
    // Global SEO metadata
    meta: {
      description: 'Aratu No Matsuri adalah festival pop culture (jejepangan) terbesar di Tulungagung. Nikmati lomba cosplay, konser musik, booth komunitas, dan masih banyak lagi pada 10 Mei 2026.',
      keywords: 'Aratu No Matsuri, event jejepangan Tulungagung, cosplay Tulungagung, festival anime, festival budaya populer, Matsuri Tulungagung, Aratu Vol 3',
    }
  },
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:url', content: 'https://aratunomatsuri.com/' }, // Update domain
